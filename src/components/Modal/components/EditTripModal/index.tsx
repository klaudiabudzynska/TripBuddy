...
const EditTripModal = ({
  ...
  const [newEndDate, setNewEndDate] = useState<Date>(endDate ? new Date(endDate) : new Date());
  ...
  return (
    <Modal isOpen={isModalOpen} title="Create a trip" closeModal={cancel} acceptAction={save}>
      <>
